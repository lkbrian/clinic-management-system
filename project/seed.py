...
def seed_database():
    ...
    # Appointment.set_appointment(child_one.Fullname,parent_one.Mothers_Name,"Influenza (flu)","Unvaccinated","Dr.Clarence Opondo","2024-04-10")
    # Appointment.set_appointment(child_two.Fullname,parent_one.Mothers_Name,"Influenza (flu) ","Unvaccinated","Dr.james Gitau","2024-04-10")
    # Appointment.set_appointment(child_three.Fullname,parent_two.Mothers_Name,"Measles,polio","Unvaccinated","Dr.Philomena Siprosa ","2024-05-20")
    # Appointment.set_appointment(child_four.Fullname,parent_two.Mothers_Name,"Measles,polio","Unvaccinated","Dr.Ann Maina","2024-06-01")
    # Appointment.set_appointment(child_five.Fullname,parent_three.Mothers_Name,"polio","vaccinated","Dr.Beatrice Nabwire","2024-03-25")
    # Appointment.set_appointment(child_six.Fullname,parent_four.Mothers_Name,"Measles","Unvaccinated","Dr.Clarence Opondo","2024-05-20")
    # Appointment.set_appointment(child_seven.Fullname,parent_five.Mothers_Name,"Diphtheria","vaccinated","Dr.Ann Mkawasi","2024-09-14")
    # Appointment.set_appointment(child_eight.Fullname,parent_six.Mothers_Name,"Haemophilus influenzae","Unvaccinated","Dr.James Gitau","2024-04-10")
